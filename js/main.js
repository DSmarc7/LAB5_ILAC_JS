function userForm(){
    ...
    document.getElementById("output").innerHTML = "First Name: " + firstname + "<br>" + "Last Name: " + lastname + "<br>" + "Email: " + email + "<br>" + "City: " + city + "<br>" + "Province: " + province + "<br>" + "Membership: " +  membershipChoice;
}
